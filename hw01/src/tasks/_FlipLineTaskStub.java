...
/**
* tasks/_FlipLineTaskStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from hw01.idl
* Friday, April 2, 2021 9:02:28 PM CEST
*/

public class _FlipLineTaskStub extends org.omg.CORBA.portable.ObjectImpl implements tasks.FlipLineTask
{

  public void update (tasks.Point[] flippedPolyLine, org.omg.CORBA.IntHolder lengthDifference)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("update", true);
                tasks.PolyLineHelper.write ($out, flippedPolyLine);
                $in = _invoke ($out);
                lengthDifference.value = $in.read_long ();
                return;
                ...
                update (flippedPolyLine, lengthDifference        );
            } finally {
                _releaseReply ($in);
            }
  } // update
